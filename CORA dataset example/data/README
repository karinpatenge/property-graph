...
This directory contains a selection of the [Cora dataset](www.research.whizbang.com/data).

The Cora dataset consists of 2708 scientific publications about Machine LeEarning classified into one of seven classes. These classes are:
